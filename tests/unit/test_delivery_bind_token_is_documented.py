...
# RUNBOOK, _runbook_step_five and test_runbook_step_five_names_the_real_field used to
# live here, checking docs/runbooks/2026-09-07-observable-delivery-workflows.md. That
# runbook moved to the private brain-v42-internal repository (ticket 8dc6f0d2); the check
