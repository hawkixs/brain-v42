...
expected_session_constraints(
 ...
 VALUES
     ...
     ('brain_sessions_status_valid', 'c', NULL::text, '4f21eff965e8da6178bb2d1030fc03f8'),
     ('brain_sessions_terminal_state_valid', 'c', NULL::text, '9abfd0c69ce694043e32e1935d17ff4f'),
...
SELECT jsonb_build_object(
 ...
 'contract_id', 'brain-v42/postgresql-recovery/v4',
 'schema_version', 4
)::text
FROM check_rows;
