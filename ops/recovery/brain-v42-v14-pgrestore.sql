...
expected_table_constraints(table_name, constraint_name, definition_md5) AS (
 VALUES
     ...
     (
         ...
         'ca60d7872bdbc605de3055be32e3b182'
     ),
     (
         'adrs',
     ...
     (
         ...
         '5fa345150d973ad03370b871bba25001'
     ),
     (
         'brain_session_artifacts',
     ...
     (
         ...
         '5cfbf6855067385e03c2b2c9b3e7a675'
     ),
     (
         'projects',
     ...
     (
         ...
         '8fdd2c54c6b20ade639980b18856e882'
     ),
     (
         'delivery_artifact_bindings',
     ...
     (
         ...
         '345851a0657f17cfa037dd8708943947'
     ),
     (
         'delivery_confirmations',
     ...
     (
         ...
         '6bfe5818127d6d671d83df9cac58a73a'
     ),
     (
         'delivery_dependencies',
     ...
     (
         ...
         '3b37bc99ff37d57aacd8ca1b6177bd77'
     ),
     (
         'delivery_receipts',
     ...
     (
         ...
         'e33305c0151ae5c9c40e165dece3857b'
     ),
     (
         'delivery_workflows',
     ...
     (
         ...
         '8913ac2d22ca367b3018690df79fbfff'
     ),
     (
         'knowledge_claim_verdicts',
     ...
     (
         ...
         '46c5581529ac770ec8ea0149e59e7e73'
     ),
     (
         'knowledge_claim_verdicts',
     ...
     (
         ...
         'e48fd63d66346a6018758aa8bbdc8a59'
     ),
     (
         'knowledge_claims',
     ...
     (
         ...
         'bb7f9e9df77db4214367222b680991b9'
     ),
     (
         'knowledge_claims',
     ...
     (
         ...
         'a6446ca68f4d82f98131e41c46f07713'
     ),
     (
         'knowledge_claims',
...
expected_table_indexes(table_name, index_name, definition_md5) AS (
 VALUES
     ...
     (
         ...
         'c2155311b1ab7c201bf4c07d3f8e5288'
     ),
     (
         'dream_runs',
         'dream_runs_pkey',
...
expected_artifact_constraints(
 ...
 VALUES
     (
         ...
         'c',
         NULL::text,
         'check (attribution_mode is null or (attribution_mode::text = any (array[''explicit''::character varying, ''derived_deposit''::character varying, ''derived_connection''::character varying, ''derived_window''::character varying])))'
     ),
     (
         'brain_session_artifacts_pkey',
         'p',
...
check_rows(id, expected, observed, passed) AS (
 ...
 SELECT
     ...
     jsonb_build_object(
         'names', extension_observation.names,
         'inventory', extension_observation.inventory
     ),
