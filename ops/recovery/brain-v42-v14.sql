...
table_sets AS (
 SELECT
     (SELECT jsonb_agg(table_name ORDER BY table_name COLLATE "C") FROM expected_tables) AS expected,
     (
         SELECT COALESCE(jsonb_agg(tablename ORDER BY tablename COLLATE "C"), '[]'::jsonb)
...
extension_observation AS (
 SELECT
     ...
     COALESCE(jsonb_agg(to_jsonb(extname) ORDER BY extname), '[]'::jsonb) AS names
...
expected_table_columns(table_name, definition_md5) AS (
 VALUES
     ...
     (
         'access_log_daily',
         'a97bbbde971f8ae4bf1d84cfd8309a89'
     ),
     (
         'adrs',
     ...
     (
         'brain_session_artifacts',
         '0786804949f040656b4bc15d72524073'
     ),
     (
         'brain_session_checkpoints',
         '0f31dc46ccd391ee7f0cb6e100fee3ee'
     ),
     (
         'brain_sessions',
     ...
     (
         'dream_runs',
         '738f6bf6328d407c972ac0d65f49ca05'
     ),
     (
         'entity_relations',
     ...
     (
         'project_contexts',
         'c5967da5e2dba4be7a8586867445b63b'
     ),
     (
         'project_focus_history',
         'c994c0ea13c3a246e55378441a3181a2'
     ),
     (
         'projects',
     ...
     (
         'search_log',
         '0f3bafdd11070755f919ad21ebec7bed'
     ),
     (
         'snippets',
     ...
     (
         'delivery_artifact_bindings',
         '72151506f1fd2d02927e4a59ddc080b3'
     ),
     (
         'delivery_attestations',
         'c11dd821acc00bf9bad9967e3e51faff'
     ),
     (
         'delivery_confirmations',
         '236c6041702d89d93d630fd249f4d476'
     ),
     (
         'delivery_contract_revisions',
         '8da213fb9d9499e99ae7b869b9c5e8db'
     ),
     (
         'delivery_dependencies',
         'a5f678355f664e849a40d5b1ee7325d1'
     ),
     (
         'delivery_events',
         'fa762b63425abd34b307fb64e4e9414f'
     ),
     (
         'delivery_receipts',
         'ee739cda314878f2f9aa28c4f8167678'
     ),
     (
         'delivery_snapshots',
         '1e870d75c17d90c23f978545f30e0820'
     ),
     (
         'delivery_workflows',
         'a7ba298bcef01cf1d5e2c9f08d7217ee'
     ),
     (
         'knowledge_claim_verdicts',
         'f76cc019dcd0d4291d698c38e834f7af'
     ),
     (
         'knowledge_claims',
         '81e5521800ab37110e9776ad98d3d0d1'
     ),
     (
         'knowledge_fact_definitions',
         'ea1badc1cf2a75fecb53c68304c9d9ae'
     )
),
...
expected_table_constraints(table_name, constraint_name, definition_md5) AS (
 VALUES
     ...
     (
         'access_log_daily',
         'pk_access_log_daily',
         '09937d1779a1edad27c9bf6b459231da'
     ),
     (
         'adrs',
     ...
     (
         'adrs',
         'adrs_status_check',
         '282e2511d4485c4bb1594c887ef4a486'
     ),
     (
         'adrs',
         'ck_adrs_freshness_source',
         '308e6ee608483373e632a5ca0c2c1706'
     ),
     (
         'adrs',
     ...
     (
         'brain_session_artifacts',
         'brain_session_artifacts_attribution_mode_valid',
         '2e164417848f9db0a8d1be919b4ad7d4'
     ),
     (
         'brain_session_artifacts',
     ...
     (
         ...
         '25ad9941e44870aaa905f583a0d558ad'
     ),
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_blocker_nonempty',
         '3df4abf41faaf07333aaa0f8a5826a5b'
     ),
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_next_step_nonempty',
         '9d3b4c771dad0ddd11c2eaf1459d9e57'
     ),
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_progress_nonempty',
         '64df634dca7747898cb916f36b7d2774'
     ),
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_seq_positive',
         'de6a9b9ad4f3fac265d9a7c672935202'
     ),
     (
         'brain_session_checkpoints',
     ...
     (
         ...
         '961fa4ce931b4430eac185433e6ad5bd'
     ),
     (
         'brain_sessions',
     ...
     (
         ...
         '8d97a41480c2c3b6ec5a87bf0e64fb03'
     ),
     (
         'brain_sessions',
         'brain_sessions_nature_valid',
         'b3899128eb71e5e3023e994b0f1e26db'
     ),
     (
         'brain_sessions',
         'brain_sessions_pkey',
     ...
     (
         ...
         'f5065acef0a32bfc97e66f6d802b9585'
     ),
     (
         'brain_sessions',
     ...
     (
         ...
         '199200e0229027db2490e19f2839fef0'
     ),
     (
         'decisions',
     ...
     (
         ...
         '3999464834a1bdabbbc3777714fc6185'
     ),
     (
         'dream_runs',
         'dream_runs_pkey',
     ...
     (
         ...
         '7599999f7135c0119f3f095e5638e1ab'
     ),
     (
         'feature_artifacts',
     ...
     (
         ...
         '28191ddbb5975edf8b7528d90587d5df'
     ),
     (
         'gitlab_events',
     ...
     (
         ...
         '941b8db51833c1b3e0601be114676919'
     ),
     (
         'indexed_plan_chunks',
         'indexed_plan_chunks_status_check',
         '60b7a6b1a4c8787f9ccbd924f971012c'
     ),
     (
         'indexed_plans',
     ...
     (
         ...
         'a22aa6504ff83744887d76d059f8f746'
     ),
     (
         'indexed_plans',
         'indexed_plans_pkey',
     ...
     (
         ...
         '65aadb85462ac3864aa3bf8aadba6df6'
     ),
     (
         'learnings',
     ...
     (
         ...
         '5cecb8d301744d1146e1e49914c3664c'
     ),
     (
         'metrics_timeseries',
     ...
     (
         'project_focus_history',
         'project_focus_history_pkey',
         'ed8e7c18926e09c027efb813c84214c3'
     ),
     (
         'project_focus_history',
         'project_focus_history_source_valid',
         '15d5b7704cebb39d5768f4f02ca5c064'
     ),
     (
         'projects',
     ...
     (
         'roadmap_curation_proposals',
         'rcp_op_valid',
         'e109d1ffbdbe81c8ec9f97a803db97e5'
     ),
     (
         'roadmap_curation_proposals',
         'rcp_status_valid',
         '5bd51f1def2256a9e087e14a6fd5b34b'
     ),
     (
         'roadmap_curation_proposals',
     ...
     (
         ...
         '004b7c34165f93cdfdc95f451298e48a'
     ),
     (
         'ticket_extraction_attempts',
     ...
     (
         ...
         'a60b19664dd88faf32310e9bb9f8f620'
     ),
     (
         'ticket_extraction_proposals',
     ...
     (
         ...
         '73279fb8eb34ad88a36f1c274865ac4e'
     ),
     (
         'tickets',
         'tickets_kind_valid',
         '4143de6e84feb363b525004833aba45e'
     ),
     (
         'tickets',
         'tickets_pkey',
     ...
     (
         ...
         'facdd80a366c53fc4d2a7b0ee70a5b10'
     ),
     (
         'delivery_artifact_bindings',
         'delivery_artifact_bindings_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'delivery_artifact_bindings',
         'delivery_artifact_bindings_ticket_id_contract_revision_fkey',
         'e07e73a72a142e2117ad35dc89a33201'
     ),
     (
         'delivery_artifact_bindings',
         'delivery_bindings_state_valid',
         'd0aed4500584744573e3aa8408c818aa'
     ),
     (
         'delivery_artifact_bindings',
         'delivery_bindings_versions_valid',
         '6cb6f93cc6a8db4edf6a59085ab1c8e6'
     ),
     (
         'delivery_artifact_bindings',
         'fk_delivery_binding_attempt_confirmation',
         '5c790d6b8dc6f124e3b334d171591fb4'
     ),
     (
         'delivery_artifact_bindings',
         'fk_delivery_binding_success_confirmation',
         '4bfbfd94febf65ae926067675ad4c2a7'
     ),
     (
         'delivery_attestations',
         'delivery_attestations_digest_valid',
         'c0381971339dbf2876eaa83edd7cc9b2'
     ),
     (
         'delivery_attestations',
         'delivery_attestations_kind_valid',
         'abdc9fcc28b3eaf4ca444b863539ce8d'
     ),
     (
         'delivery_attestations',
         'delivery_attestations_payload_object',
         'ae30ec4c4e2d3f42e684f5cad5d4d4af'
     ),
     (
         'delivery_attestations',
     ...
     (
         ...
         '88c9b5baf72f02a2e6e0b3376195bbe6'
     ),
     (
         'delivery_attestations',
         'uq_delivery_attestation_idempotency',
         '8815a35b9b9c1271910c7b909d0e37fd'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_binding_id_fkey',
         'a41f1cbc69ee117d1bd45bdf60f0c235'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_context_attempt_valid',
         'e04fa19b2eb4bf39c2f26c6458f93366'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_outcome_shape_valid',
         '3cb9cbf3a371a101f87ef1722cd87b16'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_outcome_valid',
         '60249248075b5c5962f58cb18db7f9e2'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_snapshot_id_binding_id_fkey',
         'adf48deed020c575124e5c1adee536e3'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_snapshot_id_ticket_id_contract_revi_fkey',
         '997ffdaaeb3775892313786c05f920bd'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_subject_shape_valid',
         '971f685240c11ed7b911dc13adb5ea2a'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_ticket_id_contract_revision_context_fkey',
         'b2ee48b2db5faf3efe66d02e9ce0d8b1'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_time_valid',
         '007443a84f6ef58b7e8cd21ed1f19ba7'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_binding_attempt',
         '751401ba262f965e03e4bd99641e0af4'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_binding_success',
         '5d9fba9dff48870f5800ef46634ce7f3'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_context_attempt',
         '215ef3105aeea635a5ee5bce5bf0cf62'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_context_success',
         '0ac817a0a816e0de2c585b2bf0aac5cf'
     ),
     (
         'delivery_contract_revisions',
         'delivery_contract_revisions_pkey',
         'cc51910bd1b6f2e5a39f7956cccbc08a'
     ),
     (
         'delivery_contract_revisions',
         'delivery_contract_revisions_revision_valid',
         'bebad57464f2abd57c6f50cd5746f0f2'
     ),
     (
         'delivery_contract_revisions',
         'delivery_contract_revisions_ticket_id_fkey',
         '88c9b5baf72f02a2e6e0b3376195bbe6'
     ),
     (
         'delivery_contract_revisions',
         'uq_delivery_revision_context_subject',
         '831dbbb192eeab93883510aef74bbd66'
     ),
     (
         'delivery_dependencies',
         'delivery_dependencies_milestone_valid',
         '74784fb0e34f723b552bed4b1fe9cb7b'
     ),
     (
         'delivery_dependencies',
         'delivery_dependencies_ticket_id_contract_revision_fkey',
         'e07e73a72a142e2117ad35dc89a33201'
     ),
     (
         'delivery_dependencies',
         'delivery_dependencies_upstream_ticket_id_fkey',
         '2c267df6fdb7a3b3a10d23c5c0f9ad80'
     ),
     (
         'delivery_dependencies',
         'pk_delivery_dependencies',
         'cc6694cf48d00c948ad64f0c491999fe'
     ),
     (
         'delivery_events',
         'delivery_events_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'delivery_events',
         'delivery_events_ticket_id_fkey',
         '88c9b5baf72f02a2e6e0b3376195bbe6'
     ),
     (
         'delivery_events',
         'uq_delivery_event_idempotency',
         '0536307dd7e5b23c70a54c36798d976f'
     ),
     (
         'delivery_receipts',
         'delivery_receipts_milestone_valid',
         '7a3ca94b1dbe166d77789d2ded444a9c'
     ),
     (
         'delivery_receipts',
         'delivery_receipts_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'delivery_receipts',
         'delivery_receipts_ticket_id_contract_revision_fkey',
         'e07e73a72a142e2117ad35dc89a33201'
     ),
     (
         'delivery_receipts',
         'delivery_receipts_ticket_id_fkey',
         '88c9b5baf72f02a2e6e0b3376195bbe6'
     ),
     (
         'delivery_receipts',
         'uq_delivery_receipt_milestone',
         '964beb5100af89e8ee667493854318b0'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_binding_id_fkey',
         'a41f1cbc69ee117d1bd45bdf60f0c235'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_context_attempt_valid',
         'e04fa19b2eb4bf39c2f26c6458f93366'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_subject_shape_valid',
         '971f685240c11ed7b911dc13adb5ea2a'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_ticket_id_contract_revision_context_set_fkey',
         'b2ee48b2db5faf3efe66d02e9ce0d8b1'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_binding_subject',
         '751401ba262f965e03e4bd99641e0af4'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_context_subject',
         '215ef3105aeea635a5ee5bce5bf0cf62'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_context_version_valid',
         'e51e4b7c3e47ec2a97678473f419019d'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_disposition_valid',
         '0bb2d420e5293eaf2859baf08d8dbb20'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_pkey',
         'be264ee0ec63ec82f1029aef4fa66922'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_ticket_id_fkey',
         'b658aa813cdd232541fcae27c02e9eb9'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_versions_valid',
         '66ca9ae1605ac1f807a2e2ee6f3603b4'
     ),
     (
         'delivery_workflows',
         'fk_delivery_workflow_context_id_confirmation',
         'f353a4c56b48bf98076c833c38b6ffe3'
     ),
     (
         'delivery_workflows',
         'fk_delivery_workflow_context_success_id_confirmation',
         '7e94b507e506752670f9c9c944986c22'
     ),
     (
         'delivery_workflows',
         'fk_delivery_workflow_current_context_revision',
         '31381e5d8491db212bd81ae9034b216d'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_claim_id_fkey',
         '4635fba0d6d031215f6832c233dbac3d'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_issuer_kind_valid',
         '2a07a172f3041ec33875034741975fd4'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_measurement_digest_valid',
         'ed8a996edb21a6f5be1437822d57f717'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_measurement_object',
         'b85d0944856e96b655a6bc5c48ead867'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_outcome_fingerprint_valid',
         'b60f99c7121e455d28641c54f7d04542'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_request_fingerprint_valid',
         '21098ccd646f4a9fb1a254e06eedcb71'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_seq_key',
         '26d9f9fa4a69880e8bbbba7c49b61abc'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_verdict_valid',
         '1b9605011754c23f6bf2d0987d8ff383'
     ),
     (
         'knowledge_claim_verdicts',
         'uq_knowledge_claim_verdicts_idempotency',
         '623083d08d18668c942d26d8378bd252'
     ),
     (
         'knowledge_claim_verdicts',
         'uq_knowledge_claim_verdicts_observation',
         '7137ea51247ea7a66648696ccd2a5568'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_claim_key_valid',
         'd6f281d1a6ea93e05fe32598325baf5e'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_entity_ref_id_fkey',
         '7149eed62dfab059cba03b6f188548d4'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_entity_type_valid',
         '9397839efd1486c3fd38aefd17eddf0d'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_expected_object',
         'e3d1a30c3ed854cd9328e061d2cc0afd'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_expected_resolved_object',
         '647e242377c51bca2144a4b866866178'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_fact_name_definition_version_fkey',
         'dc2c9f968fa518e6a575da18f9ed1f2d'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_pkey',
         'cc3552dbb61b18accca876af5296eb1f'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_project_key_fkey',
         'f263e7d4d142bbc04ada44537963b892'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_provenance_valid',
         '41d43cbdb380d7d6c1f27f5feecac838'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_replaces_id_fkey',
         '57053f294297cbe0df2e3021c1918486'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_seq_key',
         '26d9f9fa4a69880e8bbbba7c49b61abc'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_statement_length_valid',
         '93a7b258323ea487204c6e06382123e0'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_target_valid',
         'df043bb005c7c8eea06203d453ca17f3'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_validity_seconds_valid',
         'dcbef446507bd71b5bbf543764a7b8cb'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_digest_valid',
         'c0381971339dbf2876eaa83edd7cc9b2'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_pkey',
         'b5988b70b9087b011f5fe2e44f5348e0'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_policies_object',
         '9b7f1c9aadc897104f9c28efa28d42f9'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_target_valid',
         'df043bb005c7c8eea06203d453ca17f3'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_value_schema_object',
         'bc40ec3680d7a0b3d4ca496c08d817cd'
     ),
     (
         'project_contexts',
         'ck_project_contexts_archived_reason_needs_a_date',
         'b4b18f166e0817724cc20599a96e7776'
     )
),
...
expected_table_indexes(table_name, index_name, definition_md5) AS (
 VALUES
     ...
     (
         'access_log_daily',
         'ix_access_log_daily_entity_day',
         '0e68e5a29e34d9430e0652b12fd087f4'
     ),
     (
         'access_log_daily',
         'pk_access_log_daily',
         '8208ffcc94dca6305b1deb3054f170c6'
     ),
     (
         'adrs',
         'adrs_pkey',
     ...
     (
         ...
         'bdbff2170a02cd08d511e2710dd6fd42'
     ),
     (
         'brain_session_artifacts',
         'brain_session_artifacts_pkey',
     ...
     (
         'brain_session_checkpoints',
         'brain_session_checkpoints_pkey',
         '6c2e7d25e8c4c0bfbc96a854f1b572f3'
     ),
     (
         'brain_session_checkpoints',
         'uq_brain_session_checkpoints_session_seq',
         'ffef5bfae9f5b432ea1461278b8d8bee'
     ),
     (
         'brain_sessions',
         'brain_sessions_pkey',
     ...
     (
         'project_focus_history',
         'project_focus_history_pkey',
         '9dd17c52abd2ff070d8adb9bb440fd72'
     ),
     (
         'projects',
         'projects_pkey',
     ...
     (
         'delivery_artifact_bindings',
         'delivery_artifact_bindings_pkey',
         '0442702448eb0a104df5df03e42871b7'
     ),
     (
         'delivery_artifact_bindings',
         'uq_delivery_active_binding',
         '09d402de1601242537aa6711acfb60c9'
     ),
     (
         'delivery_attestations',
         'delivery_attestations_pkey',
         'ba625fad434d47c49ee2bc14607ee638'
     ),
     (
         'delivery_attestations',
     ...
     (
         'delivery_attestations',
         'uq_delivery_attestation_idempotency',
         'a2d003a4a86f90ada083c1a38e6e5069'
     ),
     (
         'delivery_confirmations',
         'delivery_confirmations_pkey',
         '5fbc6c8b626b618bd9261aabd6584d1f'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_binding_attempt',
         'b9d762298a2d0468031f794e2bfe155f'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_binding_success',
         '3dc3a9abb3d7ecbe9f8eb6a2da027e18'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_context_attempt',
         '70cf68ed5aec56a8995f8184126b7ffc'
     ),
     (
         'delivery_confirmations',
         'uq_delivery_confirmation_context_success',
         'ea5f9b7019387e1ae4ea1aed0c3d4f56'
     ),
     (
         'delivery_contract_revisions',
         'delivery_contract_revisions_pkey',
         '541a90e58d81a5d0906835c4936b35ba'
     ),
     (
         'delivery_contract_revisions',
         'uq_delivery_revision_context_subject',
         '1f8a98885aafb85cf8bbb311daf53179'
     ),
     (
         'delivery_dependencies',
         'pk_delivery_dependencies',
         '9ba299ecff1587c43247c87b885ccf82'
     ),
     (
         'delivery_events',
         'delivery_events_pkey',
         'b11db0726de43db7f7b6d7b6b8f39ced'
     ),
     (
         'delivery_events',
         'uq_delivery_event_idempotency',
         'a0df3f553fd61702bbde91627a5359a9'
     ),
     (
         'delivery_receipts',
         'delivery_receipts_pkey',
         'f7316b72f70b4362c72f7467f71ed85b'
     ),
     (
         'delivery_receipts',
         'uq_delivery_receipt_milestone',
         'e01cd85f929414a1df05ebafd368531b'
     ),
     (
         'delivery_snapshots',
         'delivery_snapshots_pkey',
         'b02d3e8999015385677d025d98868f62'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_binding_digest',
         '6051450415c41fffa27a3bd46558df69'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_binding_subject',
         'ed3b2c8be637bf4cbf6e8987ea06cc40'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_context_digest',
         '83498fef4f4ef6e1e25e92b6f2985fbb'
     ),
     (
         'delivery_snapshots',
         'uq_delivery_snapshot_context_subject',
         'de114d6acf58dbacd6f306bed161106d'
     ),
     (
         'delivery_workflows',
         'delivery_workflows_pkey',
         '202501f26555eed8348f767c8fdc784e'
     ),
     (
         'knowledge_claim_verdicts',
         'ix_knowledge_claim_verdicts_claim_seq',
         'b6d041d86386bb9126539874ea08761f'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_pkey',
         '90d0c32b31c713a5894b01482a5517ce'
     ),
     (
         'knowledge_claim_verdicts',
         'knowledge_claim_verdicts_seq_key',
         '79725effe8fed81c7f9e7da46be42b9f'
     ),
     (
         'knowledge_claim_verdicts',
         'uq_knowledge_claim_verdicts_idempotency',
         '3d3acdb37926fca45e3bf8242ef9174f'
     ),
     (
         'knowledge_claim_verdicts',
         'uq_knowledge_claim_verdicts_observation',
         'b953e24df79b66ad5583579d693c18fa'
     ),
     (
         'knowledge_claims',
         'ix_knowledge_claims_active_entity_ref',
         '2ef3678a9a6f37507561abf39dfcca79'
     ),
     (
         'knowledge_claims',
         'ix_knowledge_claims_active_fact_name',
         '303aa6fd3cca72cd7ffef179170f2f93'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_pkey',
         '7562b75dc99185f90bd8cb4eaf52b155'
     ),
     (
         'knowledge_claims',
         'knowledge_claims_seq_key',
         '022972cfa1c6faa36174d80761eb43a7'
     ),
     (
         'knowledge_claims',
         'uq_knowledge_claims_active_entity_key',
         '6e9eb96af83fc3de29ecda2a2973029a'
     ),
     (
         'knowledge_fact_definitions',
         'knowledge_fact_definitions_pkey',
         'fb2423802b1636c0365e2711f98843b2'
     ),
     (
         'project_contexts',
         'idx_project_contexts_archived',
         '93f1a1b837504bf451394cebc0a8bd97'
     )
),
...
expected_session_constraints(
 ...
 VALUES
     ...
     ('brain_sessions_focus_outcome_valid', 'c', NULL::text, '8d97a41480c2c3b6ec5a87bf0e64fb03'),
     ('brain_sessions_nature_valid', 'c', NULL::text, 'b3899128eb71e5e3023e994b0f1e26db'),
     ...
     ('brain_sessions_status_valid', 'c', NULL::text, 'f5065acef0a32bfc97e66f6d802b9585'),
...
expected_session_constraint_fragments(constraint_name, definition) AS (
 VALUES
     ...
     (
         'brain_sessions_terminal_state_valid',
         'nothing_to_capture_reason is null or btrim(nothing_to_capture_reason) <> ''''::text'
     ),
     (
         'brain_sessions_terminal_state_valid',
...
expected_artifact_columns(
 ...
 VALUES
     ...
     ('attribution_mode', 5, 'character varying', 'YES', 24, NULL::text)
),
expected_artifact_constraints(
 ...
 VALUES
     (
         ...
         'c',
         NULL::text,
         'check (attribution_mode is null or (attribution_mode::text = any (array[''explicit''::character varying, ''derived_deposit''::character varying, ''derived_connection''::character varying, ''derived_window''::character varying]::text[])))'
     ),
     (
         'brain_session_artifacts_pkey',
         'p',
     ...
     (
         ...
         'c',
         NULL::text,
         'check (knowledge_type::text = any (array[''decision''::character varying, ''learning''::character varying, ''snippet''::character varying, ''runbook''::character varying, ''adr''::character varying, ''indexed_plan''::character varying, ''legacy''::character varying]::text[]))'
     )
),
...
expected_column_fingerprints(object_name, definition_md5) AS (
 VALUES
     ('brain_session_artifacts', '0786804949f040656b4bc15d72524073'),
...
expected_runtime_user_triggers(table_name, trigger_name) AS (
 VALUES
     ('brain_session_checkpoints', 'brain_session_checkpoints_append_only'),
     ...
     ('project_contexts', 'project_contexts_focus_history_required'),
     ...
     ('knowledge_claim_verdicts', 'knowledge_claim_verdicts_append_only'),
     ('knowledge_claims', 'knowledge_claims_delete_gate'),
     ('knowledge_claims', 'knowledge_claims_update_gate'),
     ('knowledge_claims', 'knowledge_claims_insert_gate'),
 ...
 SELECT
     (
         ...
         LEFT JOIN pg_catalog.pg_constraint AS constraint_record
           ON constraint_record.conrelid = 'public.brain_sessions'::regclass
         ...
         JOIN pg_catalog.pg_constraint AS constraint_record
           ON constraint_record.conrelid = 'public.brain_sessions'::regclass
          AND constraint_record.conname = expected_session_constraint.constraint_name
         WHERE position(
             expected_session_constraint.definition IN lower(
                 regexp_replace(
...
artifact_constraint_mismatches AS (
 SELECT
     (
         ...
         LEFT JOIN pg_catalog.pg_constraint AS constraint_record
           ON constraint_record.conrelid = 'public.brain_session_artifacts'::regclass
          AND constraint_record.conname = expected_constraint.constraint_name
          AND constraint_record.contype::text = expected_constraint.constraint_type
          AND (
              expected_constraint.delete_action IS NULL
...
expected_sequences(
 ...
 VALUES
     ...
     ('brain_session_checkpoints_id_seq', 'brain_session_checkpoints', 'id', 'bigint', 1, 1, 9223372036854775807, 1, FALSE),
     ...
     ('knowledge_claim_verdicts_seq_seq', 'knowledge_claim_verdicts', 'seq', 'bigint', 1, 1, 9223372036854775807, 1, FALSE),
     ('knowledge_claims_seq_seq', 'knowledge_claims', 'seq', 'bigint', 1, 1, 9223372036854775807, 1, FALSE)
),
...
sequence_high_water(sequence_name, highest_assigned) AS (
 VALUES
     ...
     ('knowledge_claim_verdicts_seq_seq', (SELECT max(seq) FROM knowledge_claim_verdicts)),
     ('knowledge_claims_seq_seq', (SELECT max(seq) FROM knowledge_claims))
),
...
expected_trigger_functions(function_name, source_sha256, source_octets) AS (
 VALUES
     ('brain_session_checkpoints_append_only', 'f8f4dafb54029e8b166eb308f15f1c7bf7192222587f1320f71cd5b8d94b4aa2', 154),
     ...
     ('knowledge_claim_verdicts_append_only', '55bfc7e0b9035a711fb5b47085469df3a055438b24524f0b812e3f1d625115d8', 93),
     ('knowledge_claims_delete_gate', '26002316676e2b5705a514b27bc2d41168e510e94f81caa20a9e164f0581f787', 85),
     ('knowledge_claims_insert_gate', '9ccae1812959570d4e1a2771ca6ab365252b55a2b8af2a13a11b1ea224bf47b4', 3293),
     ('knowledge_claims_update_gate', '51db47e1275bbb4a47e5689dff0d06ba38c6f2f9ee93d972ae6e6d7906ae2b92', 1263),
...
check_rows(id, expected, observed, passed) AS (
 ...
 SELECT
     ...
     to_jsonb(extension_observation.inventory),
