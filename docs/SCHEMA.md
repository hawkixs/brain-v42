...
foundation tables below. A fresh schema at head 054 contains 44 `public` tables counting
...
proof before the MCP restart. Revision 054 is the head of the repository. Revision 038 adds
...
54 revisions (001 → 054), in `alembic/versions/`.
