...
foundation tables below. A fresh schema at head 055 contains 47 `public` tables counting
...
proof before the MCP restart. Revision 055 is the head of the repository. Revision 038 adds
...
55 revisions (001 → 055), in `alembic/versions/`.
