...
foundation tables below. A fresh schema at head 056 contains 47 `public` tables counting
...
038 through 049; 050, 051 and 052 each add exactly ONE table, 053 adds eight and 054 one more, and that is what moves it.
...
proof before the MCP restart. Revision 056 is the head of the repository. Revision 038 adds
...
56 revisions (001 → 056), in `alembic/versions/`.
