...
```
 ...
 | 69 always-on + 2 graph-gated = 71 |  | 127.0.0.1:9200       |  | 127.0.0.1:9201       |
...
│       └── tools/                # 69 always-on + 2 graph-gated = 71
├── alembic/versions/             # migrations 001 .. 056 defined in the repository
...
| MCP tools | 21 | 69 always-on + 2 graph-gated = 71 |
