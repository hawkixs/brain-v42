...
```
 ...
 | 67 always-on + 2 graph-gated = 69 |  | 127.0.0.1:9200       |  | 127.0.0.1:9201       |
...
│       └── tools/                # 67 always-on + 2 graph-gated = 69
├── alembic/versions/             # migrations 001 .. 054 defined in the repository
...
| MCP tools | 21 | 67 always-on + 2 graph-gated = 69 |
